...
FRAMEWORK_API Picture* createPicture(const char* path);
FRAMEWORK_API void drawPicture(Picture*, int x, int y);

FRAMEWORK_API void getPictureSize(Picture* s, int& w, int& h);
FRAMEWORK_API void setPictureSize(Picture* s, int w, int h);
FRAMEWORK_API void destroyPicture(Picture* s);
...
FRAMEWORK_API int run(GameFrame*);
